...
- Auto-process company flows for companies with IsActive = true and deferred payment; treat inactive companies as individual customers (do not apply company-specific deferred-processing).
