    ...
    public static void Seed(ApplicationDbContext _db)
    {
        ...
        if (!_db.Categories.Any())
        {
            _db.Categories.AddRange(
                ...
                new Category { Name = "Accessories" }  // Added new category
            );
            _db.SaveChanges();
        }
        ...
        if (!_db.SizeSystems.Any())
        {
            var sizeSystems = new List<SizeSystem>
            {
                new SizeSystem
                {
                    Name = "Adult Regular",
                    SizeType = "Regular",
                    Description = "Regular Sizes (S-XXL)",
                    IconClass = "bi-person",
                ...
                new SizeSystem
                {
                    Name = "Women Regular",
                    SizeType = "Regular",
                    Description = "Women's Regular Sizes (XS-XL)",
                    IconClass = "bi-person",
                    AlertClass = "alert-info"
                },
                new SizeSystem
                {
                    Name = "Adult Suit",
                    SizeType = "Suit",
                    Description = "Suit Sizes (44-56 EU)",
                ...
                new SizeSystem
                {
                    Name = "Kids",
                    SizeType = "Kid",
                    Description = "Kids Sizes (50-176 cm)",
                ...
                new SizeSystem
                {
                    Name = "Shoe Sizes",
                    SizeType = "Shoe",
                    Description = "Shoe Sizes (EU 35-46)",
                    IconClass = "bi-box",
        ...
        // Assign default size systems to categories
        ...
        if (!_db.Products.Any())
        {
            var products = new List<Product>
            {
                ...
                new Product
                {
                    ...
                    ImageUrl = "/images/products/suit.jpg"
                },
                ...
                new Product
                {
                    Name = "Running Shoes",
                    Brand = "Nike",
                    CategoryId = sportswearCategory.Id,
                    Description = "Lightweight running shoes",
                    ImageUrl = "/images/products/shoes.jpg"
                },
                
                // Accessories (no size system)
                new Product
                {
                    Name = "Leather Belt",
                    Brand = "Gucci",
                    CategoryId = accessoriesCategory.Id,
                    Description = "Genuine leather belt - one size fits most",
                ...
                new Product
                {
                    ...
                    Brand = "Burberry",
                    CategoryId = accessoriesCategory.Id,
                    Description = "Classic check pattern scarf",
        ...
        if (!_db.ProductVariants.Any())
        {
            ...
            {
                // T-Shirt variants (Men's Adult Regular) - with expanded colors
                ...
                // Jeans variants (Men's Adult Regular)
                ...
                // Dress variants (Women's Regular)
                ...
                // Handbag (no size variants - SizeValueId = null)
                new ProductVariant { ProductId = handbag.Id, Color = "Brown", SizeValueId = null, Price = 1999.99m, Stock = 3 }, // Low stock
                new ProductVariant { ProductId = handbag.Id, Color = "Black", SizeValueId = null, Price = 1999.99m, Stock = 5 },
                new ProductVariant { ProductId = handbag.Id, Color = "Tan", SizeValueId = null, Price = 1899.99m, Stock = 0 }, // Out of stock

                // Kids Hoodie variants (Kids sizes)
                ...
                new ProductVariant { ProductId = hoodie.Id, Color = "Yellow", SizeValueId = kidsSize104.Id, Price = 349.99m, Stock = 12 }, // Low stock
                new ProductVariant { ProductId = hoodie.Id, Color = "Yellow", SizeValueId = kidsSize116.Id, Price = 349.99m, Stock = 8 },  // Low stock
                new ProductVariant { ProductId = hoodie.Id, Color = "Pink", SizeValueId = kidsSize104.Id, Price = 349.99m, Stock = 0 },  // Out of stock

                // Suit variants (Suit sizes) - with multiple colors
                ...
                new ProductVariant { ProductId = suit.Id, Color = "Navy", SizeValueId = suitSize54.Id, Price = 4499.99m, Stock = 3 }, // Low stock
                ...
                // Shoe variants (Shoe sizes) - expanded range
                ...
                new ProductVariant { ProductId = shoes.Id, Color = "White/Blue", SizeValueId = shoeSize45.Id, Price = 1299.99m, Stock = 6 }, // Low stock
                ...
                // Belt (Accessory - no size needed, SizeValueId = null)
                ...
                // Scarf (Accessory - no size needed, SizeValueId = null)
                new ProductVariant { ProductId = scarf.Id, Color = "Black Watch", SizeValueId = null, Price = 799.99m, Stock = 8 },  // Low stock
