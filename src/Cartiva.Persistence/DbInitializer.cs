                            ...
                            RoleManager<IdentityRole> roleManager)
    {
        ...
        if (!_db.ProductVariants.Any())
        {
            ...
            var variants = new List<ProductVariant>
            {
                ...
                new() { ProductId = tshirt.Id, Color = "Navy", SizeValueId = sizeM.Id, PriceExVat = 239.99m, VatRate = 25.00m, Stock = 45 },
                new() { ProductId = tshirt.Id, Color = "Navy", SizeValueId = sizeL.Id, PriceExVat = 239.99m, VatRate = 25.00m, Stock = 40 },
                new() { ProductId = tshirt.Id, Color = "Gray", SizeValueId = sizeM.Id, PriceExVat = 239.99m, VatRate = 25.00m, Stock = 35 },
                new() { ProductId = tshirt.Id, Color = "Gray", SizeValueId = sizeL.Id, PriceExVat = 239.99m, VatRate = 25.00m, Stock = 30 },

                // Jeans
                new ProductVariant { ProductId = jeans.Id, Color = "Blue", SizeValueId = sizeS.Id, PriceExVat = 799.99m, VatRate = 25.00m, Stock = 40 },
                new() { ProductId = jeans.Id, Color = "Blue", SizeValueId = sizeM.Id, PriceExVat = 799.99m, VatRate = 25.00m, Stock = 55 },
                new() { ProductId = jeans.Id, Color = "Blue", SizeValueId = sizeL.Id, PriceExVat = 799.99m, VatRate = 25.00m, Stock = 50 },
                new() { ProductId = jeans.Id, Color = "Blue", SizeValueId = sizeXL.Id, PriceExVat = 799.99m, VatRate = 25.00m, Stock = 35 },
                new() { ProductId = jeans.Id, Color = "Black", SizeValueId = sizeM.Id, PriceExVat = 849.99m, VatRate = 25.00m, Stock = 45 },
                new() { ProductId = jeans.Id, Color = "Black", SizeValueId = sizeL.Id, PriceExVat = 849.99m, VatRate = 25.00m, Stock = 40 },
                new() { ProductId = jeans.Id, Color = "Black", SizeValueId = sizeXL.Id, PriceExVat = 849.99m, VatRate = 25.00m, Stock = 25 },
                new() { ProductId = jeans.Id, Color = "Gray", SizeValueId = sizeM.Id, PriceExVat = 799.99m, VatRate = 25.00m, Stock = 30 },
                new() { ProductId = jeans.Id, Color = "Gray", SizeValueId = sizeL.Id, PriceExVat = 799.99m, VatRate = 25.00m, Stock = 25 },

                // Dress
                new() { ProductId = dress.Id, Color = "Red", SizeValueId = womenXS.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 20 },
                new() { ProductId = dress.Id, Color = "Red", SizeValueId = womenS.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 25 },
                new() { ProductId = dress.Id, Color = "Red", SizeValueId = womenM.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 30 },
                new() { ProductId = dress.Id, Color = "Red", SizeValueId = womenL.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 20 },
                new() { ProductId = dress.Id, Color = "Blue", SizeValueId = womenS.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 28 },
                new() { ProductId = dress.Id, Color = "Blue", SizeValueId = womenM.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 32 },
                new() { ProductId = dress.Id, Color = "Blue", SizeValueId = womenL.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 25 },
                new() { ProductId = dress.Id, Color = "Blue", SizeValueId = womenXL.Id, PriceExVat = 649.99m, VatRate = 25.00m, Stock = 15 },
                new() { ProductId = dress.Id, Color = "Green", SizeValueId = womenS.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 18 },
                new() { ProductId = dress.Id, Color = "Green", SizeValueId = womenM.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 22 },
                new() { ProductId = dress.Id, Color = "Black", SizeValueId = womenM.Id, PriceExVat = 649.99m, VatRate = 25.00m, Stock = 35 },
                new() { ProductId = dress.Id, Color = "Black", SizeValueId = womenL.Id, PriceExVat = 649.99m, VatRate = 25.00m, Stock = 28 },
                new() { ProductId = dress.Id, Color = "Navy", SizeValueId = womenM.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 20 },
                new() { ProductId = dress.Id, Color = "Navy", SizeValueId = womenL.Id, PriceExVat = 599.99m, VatRate = 25.00m, Stock = 15 },

                // Handbag (no size)
                new() { ProductId = handbag.Id, Color = "Brown", SizeValueId = null, PriceExVat = 1999.99m, VatRate = 25.00m, Stock = 3 },
                new() { ProductId = handbag.Id, Color = "Black", SizeValueId = null, PriceExVat = 1999.99m, VatRate = 25.00m, Stock = 5 },
                new() { ProductId = handbag.Id, Color = "Tan", SizeValueId = null, PriceExVat = 1899.99m, VatRate = 25.00m, Stock = 0 },

                // Kids Hoodie
                new() { ProductId = hoodie.Id, Color = "Blue", SizeValueId = kidsSize104.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 40 },
                new() { ProductId = hoodie.Id, Color = "Blue", SizeValueId = kidsSize116.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 35 },
                new() { ProductId = hoodie.Id, Color = "Blue", SizeValueId = kidsSize128.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 30 },
                new() { ProductId = hoodie.Id, Color = "Blue", SizeValueId = kidsSize140.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 25 },
                new() { ProductId = hoodie.Id, Color = "Red", SizeValueId = kidsSize104.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 35 },
                new() { ProductId = hoodie.Id, Color = "Red", SizeValueId = kidsSize116.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 30 },
                new() { ProductId = hoodie.Id, Color = "Red", SizeValueId = kidsSize128.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 25 },
                new() { ProductId = hoodie.Id, Color = "Green", SizeValueId = kidsSize104.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 20 },
                new() { ProductId = hoodie.Id, Color = "Green", SizeValueId = kidsSize116.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 18 },
                new() { ProductId = hoodie.Id, Color = "Green", SizeValueId = kidsSize128.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 15 },
                new() { ProductId = hoodie.Id, Color = "Yellow", SizeValueId = kidsSize104.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 12 },
                new() { ProductId = hoodie.Id, Color = "Yellow", SizeValueId = kidsSize116.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 8 },
                new() { ProductId = hoodie.Id, Color = "Pink", SizeValueId = kidsSize104.Id, PriceExVat = 349.99m, VatRate = 25.00m, Stock = 0 },

                // Suit
                new() { ProductId = suit.Id, Color = "Black", SizeValueId = suitSize44.Id, PriceExVat = 3999.99m, VatRate = 25.00m, Stock = 8 },
                new() { ProductId = suit.Id, Color = "Black", SizeValueId = suitSize46.Id, PriceExVat = 3999.99m, VatRate = 25.00m, Stock = 10 },
                new() { ProductId = suit.Id, Color = "Black", SizeValueId = suitSize48.Id, PriceExVat = 3999.99m, VatRate = 25.00m, Stock = 12 },
                new() { ProductId = suit.Id, Color = "Black", SizeValueId = suitSize50.Id, PriceExVat = 3999.99m, VatRate = 25.00m, Stock = 8 },
                new() { ProductId = suit.Id, Color = "Black", SizeValueId = suitSize52.Id, PriceExVat = 3999.99m, VatRate = 25.00m, Stock = 6 },
                new() { ProductId = suit.Id, Color = "Navy", SizeValueId = suitSize50.Id, PriceExVat = 4299.99m, VatRate = 25.00m, Stock = 7 },
                new() { ProductId = suit.Id, Color = "Navy", SizeValueId = suitSize52.Id, PriceExVat = 4299.99m, VatRate = 25.00m, Stock = 5 },
                new() { ProductId = suit.Id, Color = "Navy", SizeValueId = suitSize54.Id, PriceExVat = 4499.99m, VatRate = 25.00m, Stock = 3 },
                new() { ProductId = suit.Id, Color = "Charcoal", SizeValueId = suitSize48.Id, PriceExVat = 4199.99m, VatRate = 25.00m, Stock = 6 },
                new() { ProductId = suit.Id, Color = "Charcoal", SizeValueId = suitSize50.Id, PriceExVat = 4199.99m, VatRate = 25.00m, Stock = 5 },
                new() { ProductId = suit.Id, Color = "Charcoal", SizeValueId = suitSize52.Id, PriceExVat = 4199.99m, VatRate = 25.00m, Stock = 4 },

                // Shoes
                new() { ProductId = shoes.Id, Color = "Black/Red", SizeValueId = shoeSize39.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 15 },
                new() { ProductId = shoes.Id, Color = "Black/Red", SizeValueId = shoeSize40.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 20 },
                new() { ProductId = shoes.Id, Color = "Black/Red", SizeValueId = shoeSize41.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 25 },
                new() { ProductId = shoes.Id, Color = "Black/Red", SizeValueId = shoeSize42.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 22 },
                new() { ProductId = shoes.Id, Color = "Black/Red", SizeValueId = shoeSize43.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 18 },
                new() { ProductId = shoes.Id, Color = "Black/Red", SizeValueId = shoeSize44.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 15 },
                new() { ProductId = shoes.Id, Color = "Black/Red", SizeValueId = shoeSize45.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 10 },
                new() { ProductId = shoes.Id, Color = "Black/Red", SizeValueId = shoeSize46.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 5 },
                new() { ProductId = shoes.Id, Color = "White/Blue", SizeValueId = shoeSize39.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 12 },
                new() { ProductId = shoes.Id, Color = "White/Blue", SizeValueId = shoeSize40.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 18 },
                new() { ProductId = shoes.Id, Color = "White/Blue", SizeValueId = shoeSize41.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 22 },
                new() { ProductId = shoes.Id, Color = "White/Blue", SizeValueId = shoeSize42.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 20 },
                new() { ProductId = shoes.Id, Color = "White/Blue", SizeValueId = shoeSize43.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 16 },
                new() { ProductId = shoes.Id, Color = "White/Blue", SizeValueId = shoeSize44.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 12 },
                new() { ProductId = shoes.Id, Color = "White/Blue", SizeValueId = shoeSize45.Id, PriceExVat = 1299.99m, VatRate = 25.00m, Stock = 6 },
                new() { ProductId = shoes.Id, Color = "All Black", SizeValueId = shoeSize40.Id, PriceExVat = 1399.99m, VatRate = 25.00m, Stock = 14 },
                new() { ProductId = shoes.Id, Color = "All Black", SizeValueId = shoeSize41.Id, PriceExVat = 1399.99m, VatRate = 25.00m, Stock = 16 },
                new() { ProductId = shoes.Id, Color = "All Black", SizeValueId = shoeSize42.Id, PriceExVat = 1399.99m, VatRate = 25.00m, Stock = 15 },
                new() { ProductId = shoes.Id, Color = "All Black", SizeValueId = shoeSize43.Id, PriceExVat = 1399.99m, VatRate = 25.00m, Stock = 12 },
                new() { ProductId = shoes.Id, Color = "All Black", SizeValueId = shoeSize44.Id, PriceExVat = 1399.99m, VatRate = 25.00m, Stock = 8 },

                // Belt (no size)
                new() { ProductId = belt.Id, Color = "Brown", SizeValueId = null, PriceExVat = 899.99m, VatRate = 25.00m, Stock = 15 },
                new() { ProductId = belt.Id, Color = "Black", SizeValueId = null, PriceExVat = 899.99m, VatRate = 25.00m, Stock = 20 },
                new() { ProductId = belt.Id, Color = "Tan", SizeValueId = null, PriceExVat = 899.99m, VatRate = 25.00m, Stock = 12 },

                // Scarf (no size)
                new() { ProductId = scarf.Id, Color = "Black Watch", SizeValueId = null, PriceExVat = 799.99m, VatRate = 25.00m, Stock = 8 }
            };
