...
namespace Cartiva.Persistence.Migrations
{
    ...
    [Migration("20260426055009_AddStripeCustomerIdAndARAdjustment")]
    partial class AddStripeCustomerIdAndARAdjustment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cartiva.Domain.AccountsReceivableAdjustment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("StripeCreditBalanceApplied")
                        .HasColumnType("bit");

                    b.Property<string>("StripeCustomerBalanceReference")
                        .HasMaxLength(100)
                    ...
                    b.ToTable("AccountsReceivableAdjustments");
                });
            ...
            modelBuilder.Entity("Cartiva.Domain.AccountsReceivableAdjustment", b =>
                {
                    ...
                    b.HasOne("Cartiva.Domain.Invoice", "Invoice")
                        .WithMany("AccountsReceivableAdjustments")
            ...
            modelBuilder.Entity("Cartiva.Domain.Invoice", b =>
                {
                    b.Navigation("AccountsReceivableAdjustments");
